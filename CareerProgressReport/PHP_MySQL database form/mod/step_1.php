		...
		<tr>
			...
			<td>
				...
				<label for="gender_m" class="radio"> 
					<input type="radio" name="gender" id="gender_m" value="m"<?php echo stickyRadio('gender', 'm'); ?> />
					<span>Male</span>
				</label>
			</td>
			<td>
				<label for="gender_f" class="radio"> 
					<input type="radio" name="gender" id="gender_f" value="f"<?php echo stickyRadio('gender', 'f'); ?> />
					<span>Female</span>
				</label>
			</td>
		</tr>
